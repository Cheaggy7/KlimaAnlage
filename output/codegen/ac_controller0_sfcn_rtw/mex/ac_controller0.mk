...
MODEL                   = ac_controller0
MODULES                 = ac_controller0_sf.c ac_controller0_sf_data.c rtGetInf.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\ac_controller0_sf.mexw64
MAKEFILE                = ac_controller0.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2023b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2023b
START_DIR               = C:\Users\kilia\Desktop\UNI\Matlab\Modellbasierte_Entwicklung\Klimaanlage1_0_2\KlimaAnlage\output\codegen
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:ac_controller0_sf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = ac_controller0_sf.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ac_controller0_ref.rsp
COMPILER_COMMAND_FILE     = ac_controller0_comp.rsp
...
ac_controller0_sf.obj : $(START_DIR)\ac_controller0_sfcn_rtw\ac_controller0_sf.c
	@cmd /C "echo ### Compiling $(START_DIR)\ac_controller0_sfcn_rtw\ac_controller0_sf.c
	$(CC) $(CFLAGS) $(START_DIR)\ac_controller0_sfcn_rtw\ac_controller0_sf.c

ac_controller0_sf_data.obj : $(START_DIR)\ac_controller0_sfcn_rtw\ac_controller0_sf_data.c
	@cmd /C "echo ### Compiling $(START_DIR)\ac_controller0_sfcn_rtw\ac_controller0_sf_data.c
	$(CC) $(CFLAGS) $(START_DIR)\ac_controller0_sfcn_rtw\ac_controller0_sf_data.c

rtGetInf.obj : $(START_DIR)\ac_controller0_sfcn_rtw\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\ac_controller0_sfcn_rtw\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\ac_controller0_sfcn_rtw\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\ac_controller0_sfcn_rtw\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\ac_controller0_sfcn_rtw\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\ac_controller0_sfcn_rtw\rtGetNaN.c
