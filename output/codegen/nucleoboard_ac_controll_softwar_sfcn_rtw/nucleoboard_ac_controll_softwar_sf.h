 ...
 *
 * hilite_system('Klimaanlage_SIL/nucleoboard_ac_controll_software')    - opens subsystem Klimaanlage_SIL/nucleoboard_ac_controll_software
 * hilite_system('Klimaanlage_SIL/nucleoboard_ac_controll_software/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'Klimaanlage_SIL'
 * '<S1>'   : 'Klimaanlage_SIL/nucleoboard_ac_controll_software'
 * '<S2>'   : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/ac_controller'
 * '<S3>'   : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/security_block'
 * '<S4>'   : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/user_interface'
 * '<S5>'   : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/security_block/Security_PowerConsumption'
 * '<S6>'   : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/security_block/Security_Temperature'
 * '<S7>'   : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/security_block/Security_PowerConsumption/If Action Subsystem1'
 * '<S8>'   : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/security_block/Security_Temperature/If Action Subsystem1'
 * '<S9>'   : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/user_interface/input_system1'
 * '<S10>'  : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/user_interface/seg_display'
 * '<S11>'  : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/user_interface/input_system1/two_state_button'
 * '<S12>'  : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/user_interface/input_system1/two_state_button/D Latch'
 * '<S13>'  : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/user_interface/input_system1/two_state_button/D Latch/D Latch'
 * '<S14>'  : 'Klimaanlage_SIL/nucleoboard_ac_controll_software/user_interface/seg_display/seg_display_controller'
 */
