...
regenerateSIL('tests/integration_test/Klimaanlage', 'qualification_test_01', 'nucleoboard_ac_controll_software', 'tests/qualification_tests/Klimaanlage_SIL', 'nucleoboard_ac_controll_software_SIL');
